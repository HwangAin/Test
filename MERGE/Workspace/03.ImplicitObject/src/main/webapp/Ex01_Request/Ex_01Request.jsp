...
<body>
	<!-- 요청방식은 크게 두가지 ( GET / POST ) 
		...
		요청 => URL로함(Servlet) => jsp ( Model(데이터) View Controller )
		1) => src 에 패키지 => servlet  => 만들기 
			 => URL로 함(JSP페이지로 이동) => jsp
			 
	-->
	<!-- Ex01_Request라는 서블릿을 만들고 요청해보기 -->	
	<!-- action servlet의 @WebServlet 그대로 가져오기 -->
	<h1>겟 방식 요청</h1>
	<form action="../Ex01_Request" method="get">
	<!-- 인풋타입 텍스트주고 이름하고 아이디 비밀번호 입력받게 만들기 -->
	<!-- name=a&id=s&pw=d -->
	...
	<!-- name=a&id=s&pw=d -->
		<p>이름 : <input type="text" name="name" placeholder="이름 입력"></p>
		<p>아이디 : <input type="text" name="id" placeholder="아이디 입력"></p>
		<p>비밀번호 : <input type="passpword" name="pw" placeholder="비밀번호 입력"></p>
		<input type="submit">
	</form>	
	...
	<h1>페이지 to 페이지</h1>
	<form action="Ex01_RequestRequest.jsp" method="get">
		<p>이름 : <input type="text" name="name" placeholder="이름 입력"></p>
		<p>아이디 : <input type="text" name="id" placeholder="아이디 입력"></p>
		<p>비밀번호 : <input type="passpword" name="pw" placeholder="비밀번호 입력"></p>
		<input type="submit">
